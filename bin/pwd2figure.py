...
def __main__():
	...
	ortho = '%s -f %s  -toPlot ordonnee:abscisse -x %s -y %s -bg white -o %s -r 3 -fSize 2' % (loca_programs.get('Programs','orthodotter'), temp4.name, str(value), str(value), options.png)
